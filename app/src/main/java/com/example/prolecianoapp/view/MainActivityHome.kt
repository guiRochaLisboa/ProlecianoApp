...
import com.example.prolecianoapp.databinding.ActivityMainHomeBinding
...
class MainActivityHome : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarMainActivityHome.fab.setOnClickListener { view ->
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.main_activity_home, menu)
        return true
    }
